...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // URL formato: https://<tenant>.sharepoint.com/sites/<site>/Shared%20Documents/Documentos/...
    // (formato do SharePoint, vem de app_settings.sharepoint_site_url -- nao hardcoded)
